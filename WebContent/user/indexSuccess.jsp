    	...
    	<div class="c3_b1">
                ...
                <div class="c3_b1_c_bottom">
                    <ul>
                    		<c:forEach items="${allProducts}"  var="product">
                    			<li>
	                           <a href="viewBook?productId=${product.id }"><img width="150px" height="170px" src="${product.img.split('[#]')[0] }"/></a>
            ...
            <div class="c3_b1_right">
               ...
               <c:forEach items="${reports }" var="report">
            				<li><a href="detailReportServlet?reportId=${report.id }">〈${report.name }〉 </a></li>
            		</c:forEach>
                </ul>
            </div>
